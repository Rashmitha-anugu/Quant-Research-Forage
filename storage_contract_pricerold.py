...
if __name__ == "__main__":
    ...
    # ------------------------------------------------------------------
    # Test 2: Multiple injection/withdrawal dates using the price
    # estimator built from the historical + extrapolated Nat_Gas data.
    # Client wants to buy gas now (thinking winter will be colder than
    # normal) across several months and sell it down across the winter.
    # ------------------------------------------------------------------
